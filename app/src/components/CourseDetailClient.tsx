...
type CourseDetailProps = {
  courseData: {
    ...
    courseBenefits: { text: string; icon: ReactNode }[];
    requirements: { text: string; icon: ReactNode }[];
  };
  relatedCourses: CourseData[];
};

export default function CourseDetailClient({ courseData, relatedCourses }: CourseDetailProps) {
